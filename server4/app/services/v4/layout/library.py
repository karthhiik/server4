...
LAYOUT_LIBRARY: tuple[LayoutSpec, ...] = (
    ...
    LayoutSpec(
        kit_id="BentoGrid",
        variant="bento-proof",
        intents=("problem", "why_now", "solution", "moat", "differentiation", "proof", "traction"),
        layout_keywords=("proof", "evidence", "signal", "bento", "insight"),
        min_words=28,
        max_words=760,
        min_bullets=3,
        max_bullets=4,
    ...
    LayoutSpec(
        kit_id="BentoGrid",
        variant="bento-insight",
        intents=("market", "go_to_market", "business_model", "strategy"),
        layout_keywords=("insight", "buyers", "motion", "loop"),
        min_words=28,
        max_words=820,
        min_bullets=3,
        max_bullets=5,
    ...
    # Premium kit layouts (Design Intelligence Upgrade)
    LayoutSpec(
        kit_id="CinematicHero",
        variant="cinematic-cover",
        intents=("title", "cover", "intro", "product_launch", "reveal"),
        layout_keywords=("cinematic", "dramatic", "hero", "cover", "opener"),
        max_words=120,
        positions=("opening",),
    ),
    LayoutSpec(
        kit_id="CinematicHero",
        variant="cinematic-gradient",
        intents=("title", "cover", "vision", "closing"),
        layout_keywords=("gradient", "dramatic", "bold"),
        max_words=100,
    ...
    LayoutSpec(
        kit_id="GlassCard",
        variant="glass-grid",
        intents=("features", "values", "benefits", "capabilities"),
        layout_keywords=("features", "cards", "grid", "capabilities"),
        max_words=400,
        max_bullets=6,
    ),
    LayoutSpec(
        kit_id="GlassCard",
        variant="glass-cards",
        intents=("features", "product", "services", "offering"),
        layout_keywords=("cards", "glass", "premium", "features"),
        max_words=360,
        max_bullets=6,
    ),
    LayoutSpec(
        kit_id="EditorialImage",
        variant="editorial-left",
        intents=("case_study", "story", "content", "about", "narrative"),
        layout_keywords=("editorial", "image", "story", "case study", "asymmetric"),
        max_words=600,
        requires=("image",),
    ),
    LayoutSpec(
        ...
        intents=("case_study", "story", "content", "about", "testimonial"),
        layout_keywords=("editorial", "image-right", "story", "narrative"),
        max_words=600,
        requires=("image",),
    ),
    # Additional premium kit layouts
    LayoutSpec(
        kit_id="DuotoneHero",
        variant="duotone-cover",
        intents=("title", "cover", "intro", "product_launch", "reveal"),
        layout_keywords=("duotone", "dramatic", "hero", "cover", "gradient"),
        max_words=120,
        positions=("opening",),
    ),
    LayoutSpec(
        kit_id="DuotoneHero",
        variant="duotone-gradient",
        intents=("title", "cover", "vision", "closing"),
        layout_keywords=("gradient", "dramatic", "bold", "duotone"),
        max_words=100,
        positions=("opening", "closing"),
    ),
    LayoutSpec(
        ...
        intents=("metrics", "traction", "highlights", "financials", "market"),
        layout_keywords=("stats", "floating", "glass", "numbers", "kpi"),
        max_words=200,
        requires=("stats",),
    ),
    LayoutSpec(
        kit_id="SplitOverlap",
        variant="split-overlap-left",
        intents=("case_study", "story", "content", "about", "narrative"),
        layout_keywords=("split", "overlap", "image", "story", "asymmetric"),
        max_words=500,
        requires=("image",),
    ),
    LayoutSpec(
        kit_id="SplitOverlap",
        variant="split-overlap-right",
        intents=("case_study", "story", "content", "about", "testimonial"),
        layout_keywords=("split", "overlap-right", "image", "story", "narrative"),
        max_words=500,
        requires=("image",),
    ),
)
